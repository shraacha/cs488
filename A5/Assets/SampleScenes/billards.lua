...
mat_normal_cube = gr.material_cook_torrance({0.1, 0.1, 0.9}, {0.5, 0.5, 0.5}, 0.9)
...
gr.render(scene, 'billiards.png', 512, 512,
	  ...
	  {0.4, 0.4, 0.4}, {l1, l2}, 30, false, 2, 100, 80, true)
